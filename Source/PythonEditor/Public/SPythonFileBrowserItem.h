...
public:
	...
	SLATE_ARGUMENT(TSharedPtr<FPyScriptModel>, InScriptTree)
...
private:
	//~ Hold this tree item
	TSharedPtr<FPyScriptModel> ScriptTree;
...
public:
	...
	bool IsSame(TSharedPtr<FPyScriptModel> Compare);

	TSharedPtr<FPyScriptModel> GetItem() const;
};
